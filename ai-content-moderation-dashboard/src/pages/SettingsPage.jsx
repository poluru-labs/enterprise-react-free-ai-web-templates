  ...
  return (
    <div className="cmb-page">
      <PageHeader
        ...
        description="Tenant, on-call coverage, and the channels that wake a reviewer."
      ...
      <div className="row g-3 mb-3">
        <div className="col-12 col-xl-7">
          <ChartSection title="Workspace" subtitle="Production content-safety tenant">
            <dl className="cmb-settings-list">
              <div>
                <dt>Name</dt>
              ...
              <div>
                <dt>Slug</dt>
                <dd className="cmb-mono">{settings.workspace.slug}</dd>
              </div>
              <div>
                <dt>Region</dt>
              ...
              <div>
                <dt>Case retention</dt>
                <dd>{settings.workspace.retentionDays} days</dd>
              </div>
              <div>
                <dt>Human SLA</dt>
                <dd>{settings.workspace.humanSlaMinutes} minutes</dd>
              </div>
              <div>
                <dt>Brand color</dt>
                <dd className="cmb-brand-swatch">
      ...
      <ChartSection title="Alert routing" subtitle="Toggle destinations. Changes stay in this browser session.">
        <div className="cmb-settings-toggles">
